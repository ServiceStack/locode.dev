---
title: Rewrite Legacy UIs with AI
description: Rewriting legacy UIs on modern AI-First stacks are now cheaper and faster than traditional development.
---
...
<ScreenshotsGallery className="not-prose mb-8" gridClass="grid grid-cols-1 md:grid-cols-2 gap-4" images={{
    'Old Home': '/img/replacing-legacy-uis/vuetify-home.webp',
    'New Home': '/img/replacing-legacy-uis/react-home.webp',
}} />
...
<ScreenshotsGallery images={{
    'Old Home': '/img/replacing-legacy-uis/vuetify-home.webp',
    'New Home': '/img/replacing-legacy-uis/react-home.webp',
    'Old Edit Post': '/img/replacing-legacy-uis/vuetify-post-edit.webp',
    'New Edit Post': '/img/replacing-legacy-uis/react-post-edit.webp',
    'Old Top': '/img/replacing-legacy-uis/vuetify-top.webp',
    'New Top': '/img/replacing-legacy-uis/react-top.webp',
    'Old TechStacks': '/img/replacing-legacy-uis/vuetify-stacks.webp',
    'New TechStacks': '/img/replacing-legacy-uis/react-stacks.webp',
    'Old Edit TechStack': '/img/replacing-legacy-uis/vuetify-stacks-edit.webp',
    'New Edit TechStack': '/img/replacing-legacy-uis/react-stacks-edit.webp',
    'Old Technology': '/img/replacing-legacy-uis/vuetify-tech.webp',
    'New Technology': '/img/replacing-legacy-uis/react-tech.webp',
    'Old Favorites': '/img/replacing-legacy-uis/vuetify-favorites.webp',
    'New Favorites': '/img/replacing-legacy-uis/react-favorites.webp',
}} />
